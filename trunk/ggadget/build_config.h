...
//
// Ported to google_gadgets_for_linux by zkfan@google.com (Zhikai Fan)
// Local Modification:
// 1. Changes header guard
...
#ifndef GGADGET_BUILD_CONFIG_H_
#define GGADGET_BUILD_CONFIG_H_
